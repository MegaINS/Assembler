...
object Lexer {
    ...
    val OPERATOR_TOKENS: Array[TokenType.Value] = Array(TokenType.PLUS, TokenType.MINUS, TokenType.COLON, TokenType.AT, TokenType.UNDERSCORE, TokenType.DOT, TokenType.LBRACKET, TokenType.RBRACKET,TokenType.SLASH)
